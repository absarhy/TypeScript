...
export function verifyResolutionCache(
    ...
    verifyPackageScopeMap(expected.impliedFormatPackageJsons, actual.impliedFormatPackageJsons, `impliedFormatPackageJsons`, /*alwaysExpectInActual*/ true);
    ...
    function verifyPackageScopeMap(
        ...
        verifyMap(
            ...
            (expectedScope, actualScope, caption) =>
                ts.Debug.assert(
                    expectedToPackageJsonScope.get(expectedScope as ts.PackageJsonScope) === actualScope ||
                        (!alwaysExpectInActual && actualScope === undefined),
